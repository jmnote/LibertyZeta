			...
			<div class="libertyzeta-content-main">
				<?php if ( $title->getNamespace() != NS_SPECIAL && $action != "edit" && $action != "history") { ?>
					<div class="social-buttons">
						<div class="google" data-url="/wiki/<?php $this->html( 'title' ) ?>" data-text="<?php $this->html( 'title' ) ?>" title="구글플러스"><div><i class="fa fa-google-plus"></i></div></div>
						<div class="twitter" data-url="/?curid=<?=$curid;?>" data-text="[<?php $this->html( 'title' ) ?>]%0A" title="트위터"><div><i class="fa fa-twitter"></i></div></div>
						<div class="facebook" data-url="/wiki/<?php $this->html( 'title' ) ?>" data-text="<?php $this->html( 'title' ) ?>" title="페이스북"><div><i class="fa fa-facebook"></i></div></div>
					</div>
				<?php } ?>
...
function nav_menu() {
	...
	<nav class="navbar navbar-dark">
		...
		<ul class="nav navbar-nav">
			<li class="nav-item">
				<?=Linker::linkKnown( SpecialPage::getTitleFor( 'Recentchanges', null ), '<span class="fa fa-refresh"></span><span class="hide-title">바뀐글</span>', array( 'class' => 'nav-link', 'title' => '최근 변경 문서를 불러옵니다. [alt+shift+r]', 'accesskey' => 'r') ); ?>
			</li>
			<li class="nav-item">
				<?=Linker::linkKnown( SpecialPage::getTitleFor( 'Randompage', null ), '<span class="fa fa-random"></span><span class="hide-title">랜덤</span>', array( 'class' => 'nav-link', 'title' => '임의 문서를 불러옵니다. [alt+shift+x]', 'accesskey' => 'x' ) ); ?>
			</li>
		...
		<div class="content-tools">
			<div class="btn-group" role="group" aria-label="content-tools">
				...
				<div class="dropdown-menu dropdown-menu-right" role="menu">
					<?php
						if ($watched != 'watch') $watchname = '주시해제';
						else $watchname = '주시';
